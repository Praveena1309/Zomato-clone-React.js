...
class Details extends React.Component{
    ...
    componentDidMount(){
        ...
        console.log(qs);
        axios({
            url:`http://localhost:5500/restaurants/${restaurants}`,
            method:"GET",
    ...
    {/*body part*/}
            <div className="container">
                <div>
                    <img src={restaurant.thumb} id="bodybox"/>
                ...
                <div>
  <button id="plsbut" onClick={() => this.handleModal('menuModal', true)}>Place Online Order </button><br/> <br/><br/>
</div>
                ...
                >
                    <div>
                        ...
                        <div className="" >
                                            ...
                                            <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                ...
                                                {item.qty == 0 ? <div>
                                                    ...
                                                    <div className="add-number">
                                                        <button id="dectotal" className="px-2" onClick={() => this.addItems(index, 'sub')} >-</button>
                                                        <span class="qty">{item.qty}</span>
                                                        <button id="intotal" className="px-2" onClick={() => this.addItems(index, 'add')} >+</button>
                                                    </div>}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button className="btn btn-danger order-button pay" id="paynowbtn"  onClick={() => {
